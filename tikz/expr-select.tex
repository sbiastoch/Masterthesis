...
\node (e11) at (6, 4) { 
    ...
    \cellcolor{gray!25}  & \cellcolor{red!15} $\TRUE$ & \cellcolor{red!15}$e_1$\\\hline
    \end{tabular}
};
...
\node (e31) at (18, 4) { 
    \begin{tabular}{|p{1em}|r|c|}\hline
    \cellcolor{gray!25} & $\highlight[yellow!15]{\TRUE}$ & $\highlight[yellow!15]{e_3}$\\\hline
    \end{tabular}
};

\node (r1) at (12, 1) {
    \begin{tabular}{|p{1em}|r|c|}\hline
    \cellcolor{gray!25}  & $\SELECT ~ \highlight[red!15]{\TRUE} ~\AND~ \highlight[green!15]{p_{2,1}} ~\AND~ \highlight[yellow!15]{\TRUE}$ & $\SELECT~ \highlight[red!15]{e_1}, \highlight[green!15]{r_{2,1}}, \highlight[yellow!15]{e_3} ~ \FROM \dots$\\\hline
    \end{tabular}
};
\node (r2) at (12, 0) {
    \begin{tabular}{|p{1em}|r|c|}\hline
    \cellcolor{gray!25} $\ast$ & $\SELECT ~ \highlight[red!15]{\TRUE} ~\AND~ \highlight[green!15]{p_{2,2}} ~\AND~ \highlight[yellow!15]{\TRUE}$ & $\SELECT~ \highlight[red!15]{e_1}, \highlight[green!15]{r_{2,2}}, \highlight[yellow!15]{e_3} ~ \FROM \dots$\\\hline
    \end{tabular}
};
