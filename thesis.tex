...
% SQL-table
\newcommand{\col}[1]{\ensuremath{\texttt{#1}}}
\newcolumntype{H}{>{\columncolor{black}\color{white}}c}
\newcolumntype{P}{>{\columncolor{white}\color{white}}c}
\newcommand{\colhd}[1]{\multicolumn{1}{H}{\strut\col{#1}}}
\newcommand{\phantomhd}[1]{\multicolumn{1}{P}{\strut\col{#1}}}
\newcommand{\mcolhd}[2]{\multicolumn{#1}{H}{\strut\col{#2}}}
\newcommand{\keyhd}[1]{\multicolumn{1}{H}{\strut\underline{\smash{\col{#1}}}}}
\newcommand{\tabname}[2]{%
  \multicolumn{#1}{@{}l}{%
...
\DeclareMathOperator{\deps}{\ensuremath{\text{deps}}}
...
\newcommand{\RREF}{\ensuremath{\text{\textsc{ref}}}}
